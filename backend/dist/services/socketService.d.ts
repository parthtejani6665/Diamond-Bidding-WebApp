 ...
 */
export declare function emitBidUpdate(diamondBidId: number, data: any): void;
/**
 ...
 */
export declare function emitAutoBidUpdate(diamondBidId: number, userId: number, data: any): void;
